  ...
  factory: function (require) {
    ...
    if (typeof document !== 'undefined' && document.querySelector('style[data-plugin-css="' + STYLE_TAG + '"]') === null) {
      ...
      tag.textContent = [
        ...
        '.dsh-kb-key { height: 30px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border-radius: 6px; border: 1px solid rgba(0,0,0,0.4); background: rgba(255,255,255,0.5); color: #1a1a1a; font-size: 10px; font-family: ui-monospace, SFMono-Regular, Menlo, monospace; box-shadow: 0 1px 0 rgba(0,0,0,0.18); transition: transform 50ms ease, box-shadow 50ms ease, background 120ms ease, color 120ms ease; }',
    ...
    function Overlay() {
      ...
      return React.createElement('div', { className: 'dsh-kb-root', style: { bottom: bottom + 'px' } },

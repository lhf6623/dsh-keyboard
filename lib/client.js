  ...
  factory: function (require) {
    ...
    if (typeof document !== 'undefined' && document.querySelector('style[data-plugin-css="' + STYLE_TAG + '"]') === null) {
      ...
      tag.textContent = [
        ...
        '.dsh-kb-wrap { display: flex; align-items: flex-start; gap: 10px; }',
    ...
    var ROWS = [
      ...
      [
        ...
        ['KeyN','N',1], ['KeyM','M',1], ['Comma',',',1], ['Period','.',1], ['Slash','/',1], ['ShiftRight','Shift',2.7], ['ArrowUp','↑',1]
      ],
      [
        ['ControlLeft','Ctrl',1.5], ['MetaLeft','Cmd',1.3], ['AltLeft','Alt',1.3], ['Space','',6],
        ['AltRight','Alt',1.3], ['MetaRight','Cmd',1.3], ['ControlRight','Ctrl',1.5], ['ArrowLeft','←',1], ['ArrowDown','↓',1], ['ArrowRight','→',1]
      ]
    ]
